...
export const metadata: Metadata = { title: 'PayRecover — Payment recovery intelligence', description: 'Understand failed checkouts, guide better retries, and measure recovered revenue.' };
